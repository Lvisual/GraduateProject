    ...
    QWidget(parent)
{
    ...
    routemanage =new RouteManage();
    empwidget =new employeeWidget();
    ...
    routemanage->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    ...
    empwidget->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
...
//    connect(this->m_navBtn, SIGNAL(clicked()), this, SLOT(setNav()));
 ...
 // *******************************END 娣诲姞瀵艰埅鏍忕粨鏉�**********************************//
    ...
    connect(title_widget, SIGNAL(showRouteWidget()),this, SLOT(showRouteManageWidget()));
    connect(title_widget, SIGNAL(showEmpWidget()),this, SLOT(showEmployeeManageWidget()));
...
void main_widget:: showRouteManageWidget()
{
    lomomainwidget->hide();
    content_widget->hide();
    jzwidget->hide();
...
void main_widget:: showEmployeeManageWidget()
{
    lomomainwidget->hide();
    content_widget->hide();
    jzwidget->hide();
